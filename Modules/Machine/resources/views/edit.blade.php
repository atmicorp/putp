<x-app-sidebar>
    <x-slot name="title">Edit Machine</x-slot>
    ...
    <x-slot name="breadcrumb">
        ...
        <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
        <span class="current">Edit Machine</span>
    </x-slot>
        ...
        <div class="form-card">
            ...
            <div class="form-card-header">
                <div class="form-card-header-left">
                    ...
                    <div>
                        <div class="form-card-title">Edit Mesin</div>
                        <div class="form-card-sub">Perbarui informasi mesin</div>
                    </div>
                </div>
                <span class="machine-code-badge">{{ $machine->code }}</span>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $machine->name) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="code" name="code" value="{{ old('code', $machine->code) }}"
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description"
                        ...
                        placeholder="Deskripsi singkat tentang mesin ini (opsional)...">{{ old('description', $machine->description) }}</textarea>
                    @error('description')
                        <div class="invalid-msg">
                            <svg width="12" height="12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                            {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-group">
                        ...
                        <div>
                            <div class="toggle-label" id="toggleLabel">{{ $machine->is_active ? 'Active' : 'Inactive' }}</div>
            ...
            <div class="form-card-footer">
                <div class="footer-left">
                    <a href="{{ route('machine.show', $machine) }}" class="btn-view">
