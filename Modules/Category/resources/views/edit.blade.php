<x-app-sidebar>
    ...
    <style>
        ...
        .form-control[readonly] { background: #f3f4f6; color: #9ca3af; cursor: not-allowed; }
    ...
    <div class="dash-title">Edit Category</div>
    <p class="dash-subtitle">Perbarui informasi category</p>
    ...
    <div class="edit-badge">
        ...
        Editing: {{ $category->nama_category }}
    </div>
        ...
        <form action="{{ route('category.update', $category) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    readonly
                >
                <div class="form-hint">Category ID tidak dapat diubah.</div>
            </div>
